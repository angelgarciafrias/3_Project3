...
class Pizzas(models.Model):
    pizza_flavor = models.ForeignKey(Flavors, on_delete=models.CASCADE, related_name="pizzas_flavor")
    pizza_crust = models.ForeignKey(Crusts, on_delete=models.CASCADE, related_name="pizzas_crust")
    pizza_size = models.ForeignKey(Sizes, on_delete=models.CASCADE, related_name="pizzas_size")
...
class Extras(models.Model):
    ...
    pizzas_extra = models.ManyToManyField(Pizzas, blank=True, related_name="pizzas_extra")
